...
DROP TABLE IF EXISTS patient_adherence_logs CASCADE;
DROP TABLE IF EXISTS patient_device_sessions CASCADE;
DROP TABLE IF EXISTS patient_articles CASCADE;
DROP TABLE IF EXISTS app_native_banners CASCADE;
DROP TABLE IF EXISTS upload_history CASCADE;
DROP TABLE IF EXISTS simrs_resep CASCADE;
DROP TABLE IF EXISTS lab_cd4 CASCADE;
DROP TABLE IF EXISTS lab_viral_load CASCADE;
...
CREATE TABLE patient_research_surveys (
    ...
    kuota_maksimal INTEGER DEFAULT 100,
